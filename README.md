...
### Troubleshooting
- A common problem is to have `mongod` not be a recognized command. A resolution for Windows can be found [on this StackOverflow post.](https://stackoverflow.com/questions/15053893/mongo-command-not-recognized-when-trying-to-connect-to-a-mongodb-server) A resolution for MacOS and Unix-based terminals [can be found here.](https://stackoverflow.com/questions/22862808/mongod-command-not-found-os-x)